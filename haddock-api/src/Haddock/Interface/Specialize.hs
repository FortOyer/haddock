...
renameLForAllTelescope :: LHsForAllTelescope GhcRn
                       -> Rename (IdP GhcRn) (LHsForAllTelescope GhcRn)
renameLForAllTelescope = located renameForAllTelescope
