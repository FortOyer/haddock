...
ppForAll :: LHsForAllTelescope DocNameI -> Unicode -> Qualification
         -> Html
ppForAll (L _ tele) unicode qual = case tele of
...
ppForAllPart :: Unicode -> Qualification -> LHsForAllTelescope DocNameI -> Html
ppForAllPart unicode qual (L _ tele) = case tele of
  HsForAllVis { hsf_vis_bndrs = bndrs } ->
