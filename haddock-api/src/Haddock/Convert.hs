...
synifyVisForAllType vs ty =
  ...
  in noLoc $ HsForAllTy { hst_tele = noLoc $ mkHsForAllVisTele sTvs
...
synifySigmaType s vs ty =
  let (tvs, ctx, tau) = tcSplitSigmaTyPreserveSynonyms ty
      ...
      sTy = HsForAllTy { hst_tele = noLoc $ mkHsForAllInvisTele sTvs
                       , hst_xforall = noExtField
                       , hst_body  = noLoc sPhi }
...
tcSplitForAllTysReqPreserveSynonyms ty =
  let (all_bndrs, body) = tcSplitForAllTysSameVisPreserveSynonyms Required ty
...
tcSplitForAllTysInvisPreserveSynonyms ty =
  let (all_bndrs, body) = tcSplitForAllTysSameVisPreserveSynonyms Specified ty
